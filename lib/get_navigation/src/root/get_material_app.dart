      ...
      builder: (_) {
        final routerDelegate = Get.createDelegate(
            ...
            navigatorObservers: (navigatorObservers == null
                ...
                : <NavigatorObserver>[GetObserver(routingCallback, Get.routing), ...navigatorObservers!]));

        final routeInformationParser = Get.createInformationParser(
          initialRoute: initialRoute ?? getPages?.first.name ?? _cleanRouteName("/${home.runtimeType}"),
        );
